 ...
 * \param [in] instream_DrugiVektor The stream should be of size ((param_N * 2) * 4) bytes.
 * \param [in] instream_PrviVektor The stream should be of size ((param_N * 2) * 4) bytes.
 * \param [out] outstream_IzlazniVektor The stream should be of size ((param_N * 2) * 4) bytes.
 */
void Vectors(
	int32_t param_N,
	const uint32_t *instream_DrugiVektor,
	const uint32_t *instream_PrviVektor,
	uint32_t *outstream_IzlazniVektor);
...
typedef struct { 
	...
	const uint32_t *instream_DrugiVektor; /**<  [in] The stream should be of size ((param_N * 2) * 4) bytes. */
	const uint32_t *instream_PrviVektor; /**<  [in] The stream should be of size ((param_N * 2) * 4) bytes. */
	uint32_t *outstream_IzlazniVektor; /**<  [out] The stream should be of size ((param_N * 2) * 4) bytes. */
} Vectors_actions_t;
